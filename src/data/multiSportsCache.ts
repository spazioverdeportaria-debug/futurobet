...
export const FALLBACK_BASKETBALL_MATCHES: SportsMatch[] = [
  {
    ...
    awayScore: 84,
    timeMinute: 3,
    timeFormatted: 'Q3 04:12 🔴',
    timeOnly: '22:30',
    dayFormatted: 'Ao Vivo',
    fullDateTimeFormatted: 'Ao Vivo • 3º Quarto (88 x 84)',
  ...
  },
  {
    ...
    awayColor: 'from-blue-900 to-amber-600',
    homeScore: 102,
    awayScore: 99,
    timeMinute: 4,
    timeFormatted: 'Q4 02:18 🔴',
    timeOnly: '21:00',
    dayFormatted: 'Ao Vivo',
    fullDateTimeFormatted: 'Ao Vivo • 4º Quarto (102 x 99)',
    dateTimestamp: Date.now() - (90 * 60 * 1000),
    isLive: true,
    status: 'IN_PLAY',
    ...
    odds: {
      ...
      spreadHomeOdd: 1.90,
      spreadAwayOdd: 1.90,
      totalPointsLine: 221.5,
      overTotalPoints: 1.87,
      underTotalPoints: 1.87,
    },
    stats: {
      fieldGoalHome: 52,
      fieldGoalAway: 49,
...
export const FALLBACK_TENNIS_MATCHES: SportsMatch[] = [
  {
    ...
    awayScore: 1,
    timeMinute: 45,
    timeFormatted: "Set 3 (4-3) 🎾 Ao Vivo",
    timeOnly: "Ao Vivo",
    dayFormatted: "Hoje",
    fullDateTimeFormatted: "Hoje • Em Andamento",
...
export const FALLBACK_ESPORTS_MATCHES: SportsMatch[] = [
  {
    ...
    awayScore: 0,
    timeMinute: 22,
    timeFormatted: "Mapa 2 (11-9) 🎮 Ao Vivo",
    timeOnly: "Ao Vivo",
    dayFormatted: "Hoje",
    fullDateTimeFormatted: "Hoje • Ao Vivo (MD3)",
    dateTimestamp: Date.now(),
    isLive: true,
